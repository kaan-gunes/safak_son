...
<h1>IMX708 · Önizleme · Kayıt kapalı</h1>
<p><b>Otomatik kontrol kapalı</b> · Yalnız kamera · Kalibrasyon henüz yok</p>
...
s.textContent=d.error||`${d.camera.model} · Kamera ${cameraFps.toFixed(1)} FPS · Panel ${displayFps.toFixed(1)} FPS · Kare ${d.frame_id} · Yaş ${d.age_ms} ms · Odak: ${d.focus_mode}`
...
state = {"frame_id": 0, "at": 0, "image": None, "jpeg": None,
         "jpeg_frame_id": 0, "jpeg_at": 0, "error": None, "metadata": {}, "focus_mode": "sabit", "camera": {}}
