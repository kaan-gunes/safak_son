...
**Yeni “0,1 saniye gör → dur → doğrula → merkezle/bırak veya rotaya dön” akışı için [tek sayfalık kod ve kütüphane rehberi](docs/competition/AKIS.md).** Giriş `safak_gorev2.competition.main`, profil `config/competition-center.json`. Eski quad uygulaması farklıdır. Bu revizyonun testleri [burada](docs/competition/TESTLER.md); Pi'ye dağıtılmadı ve gerçek uçuş kabulü yapılmadı.
